...
async function main() {
  ...
  const newsItems = [
    ...
    { title: "Solana dépasse Ethereum en transactions quotidiennes", description: "Le réseau Solana traite désormais plus de transactions par jour qu'Ethereum.", url: "https://example.com/sol-eth", source: "CoinDesk", category: "Crypto", relevanceScore: 0.78, imageUrl: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=400" },
  ];
